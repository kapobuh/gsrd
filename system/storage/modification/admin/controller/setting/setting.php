...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
        ...
        if (isset($this->request->post['config_optpricelimit'])) {
			$data['config_optpricelimit'] = $this->request->post['config_optpricelimit'];
		} else {
			$data['config_optpricelimit'] = $this->config->get('config_optpricelimit');
		}
        ...
        if (isset($this->request->post['config_autoregister'])) {
			$data['config_autoregister'] = $this->request->post['config_autoregister'];
		} else {
			$data['config_autoregister'] = $this->config->get('config_autoregister');
		}
