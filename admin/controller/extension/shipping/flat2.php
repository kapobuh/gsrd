...
class ControllerExtensionShippingFlat2 extends Controller {
	...
	public function index() {
		...
		$data['action'] = $this->url->link('extension/shipping/flat2', 'token=' . $this->session->data['token'], true);
		...
		if (isset($this->request->post['flat2_free_limit'])) {
			$data['flat2_free_limit'] = $this->request->post['flat2_free_limit'];
		} else {
			$data['flat2_free_limit'] = $this->config->get('flat2_free_limit');
		}
