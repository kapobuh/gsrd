...
class ControllerTotalDiscount extends Controller { 
	...
	public function index() { 
		...
		if (isset($this->request->post['discount_customer_group_id'])) {
			$data['discount_customer_group_id'] = $this->request->post['discount_customer_group_id'];
		} else {
			$data['discount_customer_group_id'] = $this->config->get('discount_customer_group_id');
		}
