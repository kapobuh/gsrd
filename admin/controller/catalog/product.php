...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
		...
		$data['entry_name'] = $this->language->get('entry_name');
		$data['entry_min_desc'] = $this->language->get('entry_min_desc');
		...
		if (isset($this->request->post['product_delivery'])) {
			$data['product_delivery'] = $this->request->post['product_delivery'];
		} elseif (isset($this->request->get['product_id'])) {
			$data['product_delivery'] = $this->model_catalog_product->getProductDescriptions($this->request->get['product_id']);
		} else {
			$data['product_delivery'] = array();
		}
		...
		if (isset($this->request->post['min_desc'])) {
			$data['min_desc'] = $this->request->post['min_desc'];
		} elseif (!empty($product_info)) {
			$data['min_desc'] = $product_info['min_desc'];
		} else {
			$data['min_desc'] = '';
		}
