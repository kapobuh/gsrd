            ...
            <div class="tab-pane" id="tab-option">
              <fieldset>
                ...
                <div class="form-group required">
                  ...
                  <div class="form-group required">
                  <label class="col-sm-2 control-label" for="input-config_optpricelimit"><span data-toggle="tooltip" title="Работает только для определнной группы клиентов (с id=3)">Начальная сумма для оптовых цен</span></label>
                  <div class="col-sm-10">
                    <input type="text" name="config_optpricelimit" value="<?php echo $config_optpricelimit; ?>" placeholder="0" id="input-config_optpricelimit" class="form-control" />
                    </div>
                </div>
              </fieldset>
              <fieldset>
              ...
              <fieldset>
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                  <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="Автоматически регистрировать клиентов при оформлении заказа без регистрации">Автоматическая регистрация клиента</span></label>
                  <div class="col-sm-10">
                    <label class="radio-inline">
                      <?php if ($config_autoregister) { ?>
                      <input type="radio" name="config_autoregister" value="1" checked="checked" />
                      <?php echo $text_yes; ?>
                      <?php } else { ?>
                      <input type="radio" name="config_autoregister" value="1" />
                      <?php echo $text_yes; ?>
                      <?php } ?>
                    </label>
                    <label class="radio-inline">
                      <?php if (!$config_checkout_guest) { ?>
                      <input type="radio" name="config_autoregister" value="0" checked="checked" />
                      <?php echo $text_no; ?>
                      <?php } else { ?>
                      <input type="radio" name="config_autoregister" value="0" />
                      <?php echo $text_no; ?>
                      <?php } ?>
                    </label>
                  </div>
