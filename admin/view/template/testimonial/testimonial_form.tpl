      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-review" class="form-horizontal">
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <input type="text" name="author" value="<?php echo $author; ?>" placeholder="<?php echo $entry_author; ?>" id="input-author" class="form-control" />
				<?php if ($author) { ?>
				<p style="margin:5px 0 0 5px;"><?php echo $age ; ?> лет, <?php echo $city; ?></p>
				 <?php } ?>
              <?php if ($error_author) { ?>
            ...
            <div class="col-sm-10">
              <input type="text" name="email" value="<?php echo $email; ?>" placeholder="Email для ответа" id="input-email" class="form-control" />
          ...
          <div class="form-group">
			...
			<div class="pull-right">
				<label class="control-label" for="send_answer"></label>
          ...
          <div class="form-group required">
			...
			<div class="form-group required">
            <label class="col-sm-2 control-label" for="input-text">Ответ</label>
            <div class="col-sm-10">
              <textarea name="response" cols="60" rows="8" placeholder="Ответ админа" id="input-response" class="form-control"><?php echo $response; ?></textarea>
              
            </div>
          </div>
			<div class="form-group">
            <label class="col-sm-2 control-label" for="input-text">Отправить ответ клиенту</label>
            <div class="col-sm-10">
              <input type="checkbox" name="send_answer" id="send_answer" style="margin-top:10px;">
            </div>
          </div>
...
<script type="text/javascript">
	...
	/*$(document).ready(function(){
		$('#send_btn').click(function(){
			...
			$.ajax({
				url: 'index.php?route=testimonial/testimonial/send',
				type: 'post',
				data: 'review_id=<?php echo $_GET["review_id"]; ?>'+'&review_text='+$('#input-response').val(),
				beforeSend: function () {
					$('#send_btn').html('Загрузка...');
					$('#send_btn').attr('disable');
				},
