      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-customer-group" class="form-horizontal">
          ...
          <div class="form-group">
			...
			<div class="form-group">
            <label class="col-sm-2 control-label" for="input-discount-percent"><?php echo $entry_discount_percent; ?></label>
            <div class="col-sm-10">
              <input type="text" name="discount_percent" value="<?php echo $discount_percent; ?>" placeholder="<?php echo $entry_discount_percent; ?>" id="input-discount-percent" class="form-control" />
            </div>
          </div>
          <div class="form-group">
