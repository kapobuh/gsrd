                    ...
                    <div class="tab-pane active" id="tab-customer">
                      <?php if ($alert_email) { ?>
                        ...
                        <div class="col-sm-2 text-right">
                          <input id="input-alert_email" type="checkbox" checked name="alert_email" class="form-control pull-right"/>
                        </div>
							<label style="color:#1e91cf;padding-top:0px;text-align:left" class="col-sm-10 control-label" for="input-alert_email"><?php echo $entry_alert_email; ?></label>
                        </div>
					<?php }	 ?>
					 <div class="form-group">
