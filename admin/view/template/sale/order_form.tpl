      ...
      <div class="panel-body">
        <form class="form-horizontal">
          <ul id="order" class="nav nav-tabs nav-justified">
            ...
            <li class="disabled"><a href="#tab-payment" data-toggle="tab">3. Адрес доставки <?php //echo $tab_payment; ?></a></li>
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-payment">
              ...
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-payment-address-1">Адрес</label>
                <div class="col-sm-10">
                  <input type="text" name="address_1" value="<?php echo $payment_address_1; ?>" id="input-payment-address-1" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-payment-address-2">Дата и время доставки</label>
                <div class="col-sm-10">
            ...
            <div class="tab-pane" id="tab-shipping">
				...
				<div class="form-group required">
                <label class="col-sm-2 control-label" for="input-shipping-customship_name" style="color:#1E91CF;">Способ доставки</label>
                <div class="col-sm-10">
                  <input type="text" name="customship_name" value="<?php echo $shipping_method; ?>" id="input-shipping-customship_name" class="form-control" />
                </div>
              </div>
				
				<div class="form-group required">
                <label class="col-sm-2 control-label" for="input-shipping-customship_val" style="color:#1E91CF;">Cтоимость доставки</label>
                <div class="col-sm-10">
                  <input type="text" name="customship_val" value="<?php echo $shipping_val; ?>" id="input-shipping-customship_val" class="form-control" />
                </div>
              </div>
            ...
            <div class="tab-pane" id="tab-total">
              ...
              <fieldset>
				...
				<div class="form-group">
                  <label class="col-sm-2 control-label" for="input-sale">Скидка на заказ(руб.)</label>
                  <div class="col-sm-10">
                    <div class="input-group">
                      <input type="text" name="sale" value="" id="input-sale" class="form-control" />
                      <span class="input-group-btn">
                      <button type="button" id="button-sale" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary"><?php echo $button_apply; ?></button>
                      </span></div>
                  </div>
                </div>
				<div class="form-group">
                  <label class="col-sm-2 control-label" for="input-saleperc">Скидка на заказ(%)</label>
                  <div class="col-sm-10">
                    <div class="input-group">
                      <input type="text" name="saleperc" value="" id="input-saleperc" class="form-control" />
                      <span class="input-group-btn">
                      <button type="button" id="button-saleperc" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary"><?php echo $button_apply; ?></button>
                      </span></div>
                  </div>
                </div>
                <div class="form-group">
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['error']) {
				...
				$('#input-shipping-country').val($('#input-payment-country').val());
...
var shipping_zone_id = '<?php echo $payment_zone_id; //$shipping_zone_id; ?>';
								...
								for (i in json['shipping_methods']) {
									...
									if (!json['shipping_methods'][i]['error']) {
										for (j in json['shipping_methods'][i]['quote']) {
											...
											if (json['shipping_methods'][i]['quote'][j]['code'] != 'flat2.flat2') {
...
$('#button-sale').on('click', function() {
	$.ajax({
		url: '<?php echo $catalog; ?>index.php?route=api/sale&token=' + token + '&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
		data: 'sale=' + $('input[name=\'sale\']').val(),
		dataType: 'json',
		crossDomain: true,
		beforeSend: function() {
			$('#button-sale').button('loading');
		},
		complete: function() {
			$('#button-sale').button('reset');
		},
		success: function(json) {
			$('.alert, .text-danger').remove();
			$('.form-group').removeClass('has-error');
			...
			if (json['error']) {
				...
				// Highlight any found errors
				$('input[name=\'sale\']').closest('.form-group').addClass('has-error');
			}
...
// Sale на заказ в процентах
$('#button-saleperc').on('click', function() {
	$.ajax({
		url: '<?php echo $catalog; ?>index.php?route=api/saleperc&token=' + token + '&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
		data: 'saleperc=' + $('input[name=\'saleperc\']').val(),
		dataType: 'json',
		crossDomain: true,
		beforeSend: function() {
			$('#button-saleperc').button('loading');
		},
		complete: function() {
			$('#button-saleperc').button('reset');
		},
		success: function(json) {
			$('.alert, .text-danger').remove();
			$('.form-group').removeClass('has-error');
			...
			if (json['error']) {
				...
				// Highlight any found errors
				$('input[name=\'saleperc\']').closest('.form-group').addClass('has-error');
			}
