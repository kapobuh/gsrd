...
<div class="container" style="margin-top:200px;">
  ...
  <br/>
	...
	<br/>
	<h3 class="center-block" style="width:95%;">Заказ №<?php echo $order['order_id']; ?></h3>
	<?php if ($order['show_order_status']) { ?>
	<h4 class="center-block" style="width:95%;">Статус заказа: <?php echo $order['order_status']; ?></h4>
	<?php } ?>
