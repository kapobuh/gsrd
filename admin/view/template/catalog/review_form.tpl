      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-review" class="form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="form-group">
            <label class="col-sm-2 control-label" for="input-show_in_slider">Показывать на главной</label>
            <div class="col-sm-10">
              <select name="show_in_slider" id="input-show_in_slider" class="form-control">
                <?php if ($show_in_slider) { ?>
