							...
							<div class="tab-pane active" id="tab-general">
								...
								<div class="tab-content">
									...
									<div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
										...
										<div class="form-group required">
											<label class="col-sm-2 control-label" for="input-annonce<?php echo $language['language_id']; ?>"><?php echo $entry_annonce; ?></label>
											<div class="col-sm-10">
												<textarea name="news_description[<?php echo $language['language_id']; ?>][annonce]" placeholder="<?php echo $entry_annonce; ?>" id="input-description<?php echo $language['language_id']; ?>" class="form-control summernote"><?php echo isset($news_description[$language['language_id']]) ? $news_description[$language['language_id']]['annonce'] : ''; ?></textarea>
												<?php if (isset($error_annonce[$language['language_id']])) { ?>
												<div class="text-danger"><?php echo $error_annonce[$language['language_id']]; ?></div>
												<?php } ?>
											</div>
										</div>
